...
| --- | --- | --- |
| SA-1 | AC-003-rbac.md | "\[AC-003-rbac\]"`(docs/01-prd/acceptance-criteria/AC-003-rbac.md)` |
| SA-1 | PRD-FUNC-003-iam.md | "\[PRD-FUNC-003-iam\]"`(docs/01-prd/functional/PRD-FUNC-003-iam.md)` |
| SA-1 | 0006-rbac.md | "\[0006-rbac\]"`(docs/03-adr/0006-rbac.md)` |
